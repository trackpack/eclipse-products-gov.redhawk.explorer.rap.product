 ...
 *******************************************************************************/
package gov.redhawk.entrypoint.scaExplorer.internal;
...
/**
 * This class is not currently used because the element factory (see comment below) is not supported in RAP
 */
public class ResourceFactory implements IElementFactory, IPersistableElement {
	...
	//Not currently available in RAP
